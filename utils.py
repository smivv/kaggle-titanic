...
def plot_confusion_matrix2(y_true, y_pred, labels, ymap=None, figsize=(10, 10)):
    """
...
def plot_confusion_matrix(y_true, y_pred, labels, ymap=None, figsize=(10, 10)):
    ...
    axes.imshow(cm, interpolation='nearest', cmap=plt.cm.viridis)
...
def draw_confusion_matrix(axes, cm, labels, title='Confusion matrix'):
